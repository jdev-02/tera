...
if __name__ == "__main__":
    ...
    print(
        "Forward to RoutingAgent?",
        json.dumps(is_safe_to_forward(legit, "RoutingAgent"), indent=2),
    )
    ...
    print(
        "Forward to RoutingAgent?",
        json.dumps(is_safe_to_forward(hostile, "RoutingAgent"), indent=2),
    )
    ...
    print(
        ...
        json.dumps(is_safe_to_forward(overlay, "PolicyAgent"), indent=2),
    )
