...
public class ViewOverlayExample extends AbstractMapComponent
    ...
    public static final String TOGGLE_OVERLAY_VIEW = "com.atakmap.android.helloworld.view.TOGGLE_OVERLAY_VIEW";
    ...
    private void updateOverlayPosition() {
        ...
        RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) overlayView
                .getLayoutParams();
